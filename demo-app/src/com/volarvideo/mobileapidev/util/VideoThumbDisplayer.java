...
public class VideoThumbDisplayer implements BitmapDisplayer {
	...
	@Override
	public void display(Bitmap bitmap, ImageAware imageAware, LoadedFrom lf) {		
		...
		ImageView view = (ImageView) imageAware.getWrappedView();
		if(view != null) {
			view.setBackgroundDrawable(new BitmapDrawable(view.getContext().getResources(), roundedBitmap));
			imageAware.setImageBitmap(playButton);
		}
	}
